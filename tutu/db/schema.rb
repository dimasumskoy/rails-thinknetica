...
ActiveRecord::Schema.define(version: 20170602172059) do
  ...
  create_table "railcars", force: :cascade do |t|
    ...
    t.index ["kind"], name: "index_railcars_on_kind"
  ...
  create_table "railway_stations_routes", force: :cascade do |t|
    ...
    t.integer "route_id"
    t.integer "railway_station_position_id"
    t.index ["railway_station_id"], name: "index_railway_stations_routes_on_railway_station_id"
    t.index ["railway_station_position_id"], name: "index_railway_stations_routes_on_railway_station_position_id"
